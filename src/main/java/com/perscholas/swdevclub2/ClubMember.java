...
public class ClubMember {
    ...
    public ClubMember(String[] memberInfo) {
        this.name = memberInfo[0];
        this.city = memberInfo[1];
        this.state = memberInfo[2];
        this.favoriteLanguage = memberInfo[3];
    }
    ...
    boolean equals(String[] memberInfo) {
        return getName().equals(memberInfo[0])
            && getCity().equals(memberInfo[1])
            && getState().equals(memberInfo[2]);
    }
}
